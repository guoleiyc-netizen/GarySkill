  ...
  styles: {
    ...
    paragraphStyles: [
      ...
      },
      {
        ...
        next: "Normal",
        quickFormat: true,
        run: { size: 26, bold: true, color: "2E5090", font: "微软雅黑" },
      ...
      },
      {
        ...
        name: "Cover Title",
        basedOn: "Normal",
        run: { size: 44, bold: true, color: "1F4D78", font: "微软雅黑" },
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        ...
        children: [new TextRun({ text: "与会人员", bold: true, size: 26, color: "1F4D78" })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("二、会议开场与规则说明")]
      }),

      new Paragraph({
        spacing: { before: 200, after: 120 },
        children: [new TextRun({ text: "私董官郭志梁：", bold: true, size: 24 })]
      }),

      new Paragraph({
        style: "Quote",
        children: [new TextRun("私董会的核心宗旨：以案主的问题为中心，通过多元视角和共创共建，共同探求真理，帮助案主找到收获和启发。")]
      }),

      new Paragraph({
        spacing: { before: 240, after: 120 },
        children: [new TextRun({ text: "核心规则", bold: true, size: 26, color: "1F4D78" })]
      }),
      new Paragraph({
        numbering: { reference: "bullet-list", level: 0 },
        children: [
      ...
      new Paragraph({
        spacing: { before: 240, after: 120 },
        children: [new TextRun({ text: "三大原则", bold: true, size: 26, color: "1F4D78" })]
      }),
      new Paragraph({
        numbering: { reference: "bullet-list", level: 0 },
        children: [
      ...
      new Paragraph({
        spacing: { before: 240, after: 120 },
        children: [new TextRun({ text: "保密宣誓", bold: true, size: 26, color: "1F4D78" })]
      }),
      new Paragraph({
        style: "Quote",
        children: [new TextRun("全体与会成员共同宣读并承诺遵守保密协议：我承诺对本次私董会的所有讨论内容严格保密，不对外传播任何与会人员的分享内容。")]
      }),

      new Paragraph({
        spacing: { before: 240, after: 120 },
        children: [new TextRun({ text: "流程说明", bold: true, size: 26, color: "1F4D78" })]
      }),
      new Paragraph({
        numbering: { reference: "bullet-list", level: 0 },
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("三、成员自我介绍与破冰分享")]
      }),

      new Paragraph({
        spacing: { before: 200, after: 160 },
        children: [
          new TextRun({ text: "破冰主题：", bold: true, size: 26, color: "1F4D78" }),
          new TextRun("跨界与转型经历分享")
        ]
      }),
      ...
      new Paragraph({
        ...
        children: [new TextRun("Echo（留学顾问）")]
      }),
      new Paragraph({
        numbering: { reference: "bullet-list", level: 0 },
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("龚姗姗（保险经纪人）")]
      }),
      new Paragraph({
        numbering: { reference: "bullet-list", level: 0 },
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("刘丽芬（Amber，国企银行）")]
      }),
      new Paragraph({
        numbering: { reference: "bullet-list", level: 0 },
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("蒋幼隆（张老师，设计师）")]
      }),
      new Paragraph({
        numbering: { reference: "bullet-list", level: 0 },
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("徐贵生（阿贵，设计师）")]
      }),
      new Paragraph({
        numbering: { reference: "bullet-list", level: 0 },
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("江南（案主，设计师）")]
      }),
      new Paragraph({
        numbering: { reference: "bullet-list", level: 0 },
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("四、案主阐述案题")]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("背景信息")]
      }),
      new Paragraph({
        spacing: { before: 200, after: 160 },
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_2,
        children: [new TextRun("这个问题是重要的，因为")]
      }),
      new Paragraph({
        numbering: { reference: "bullet-list", level: 0 },
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("五、第一轮提问（信息收集）")]
      }),
      new Paragraph({
        spacing: { before: 200, after: 160 },
        children: [new TextRun({ text: "【本环节包含多位幕僚的详细提问，内容详见原文档】", italics: true, color: "7F7F7F" })]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("六、第二轮提问（深入探讨）")]
      }),
      new Paragraph({
        spacing: { before: 200, after: 160 },
        children: [new TextRun({ text: "【本环节深入探讨案主问题，内容详见原文档】", italics: true, color: "7F7F7F" })]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("七、补充提问环节")]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("八、隔墙有耳（幕僚内部讨论）")]
      }),
      new Paragraph({
        spacing: { before: 200, after: 160 },
        children: [new TextRun({ text: "【案主背对，幕僚自由讨论真问题】", italics: true, color: "7F7F7F" })]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("九、幕僚反馈环节")]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("十、案主总结")]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("十一、送你一朵小红花")]
      }),

      new Paragraph({
        heading: HeadingLevel.HEADING_1,
        children: [new TextRun("十二、合影与结束")]
      }),
      new Paragraph({
        spacing: { before: 200, after: 160 },
        children: [new TextRun("全体成员合影留念，会议圆满结束。")]
      }),
      ...
      new Paragraph({
        ...
        alignment: AlignmentType.CENTER,
        children: [new TextRun({ text: "会议信息", bold: true, size: 28, color: "1F4D78" })]
      }),

      new Paragraph({
        spacing: { before: 240, after: 120 },
        alignment: AlignmentType.CENTER,
        children: [new TextRun({ text: "会议时间：2026年2月8日 14:55-18:15", size: 22, color: "595959" })]
      }),
      new Paragraph({
        spacing: { before: 0, after: 120 },
        alignment: AlignmentType.CENTER,
        children: [new TextRun({ text: "整理时间：2026年2月8日", size: 22, color: "595959" })]
      }),
      new Paragraph({
        spacing: { before: 0, after: 120 },
        alignment: AlignmentType.CENTER,
        children: [new TextRun({ text: "记录来源：纵横私董会第143期", size: 22, color: "595959" })]
      }),
      new Paragraph({
        spacing: { before: 0, after: 120 },
        alignment: AlignmentType.CENTER,
        children: [new TextRun({ text: "案主：江南（返场，上一次为第137期，2024年11月23日）", size: 22, color: "595959" })]
      }),
      new Paragraph({
        spacing: { before: 0, after: 120 },
        alignment: AlignmentType.CENTER,
        children: [new TextRun({ text: "私董官：郭志梁", size: 22, color: "595959" })]
      }),
      new Paragraph({
        spacing: { before: 0, after: 0 },
        alignment: AlignmentType.CENTER,
        children: [new TextRun({ text: "运营：朱一溟", size: 22, color: "595959" })]
      })
    ]
  }]
});
...
Packer.toBuffer(doc).then(buffer => {
  ...
  console.log("优化版文档已生成：E:/workday/纵横私董会会议纪要/整理完成/江南_优化版.docx");
});
